    ...
    return (
        <footer className={`shrink-0 overflow-hidden transition-all duration-500 ease-in-out ${isFeedbackMode ? 'max-h-96' : 'max-h-[68px]'}`}>
            ...
            <div className="p-4 space-y-3">
                <textarea value={feedbackText} onChange={(e) => setFeedbackText(e.target.value)} placeholder="e.g., 'Make the charts blue' or 'Add a section about financial impact.'" className="w-full h-24 p-2 rounded-lg resize-none bg-black/10 dark:bg-black/20 border border-transparent focus:border-glow-light dark:focus:border-glow-dark focus:ring-2 focus:ring-glow-light/50 dark:focus:ring-glow-dark/50 focus:outline-none transition-all text-sm"/>
