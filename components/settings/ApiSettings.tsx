...
const ApiSettings: React.FC<ApiSettingsProps> = ({ apiKey, setApiKey }) => {
    ...
    return (
        <div className="space-y-4 animate-fade-in">
            ...
            {isEnvKey ? (
                <div className="w-full p-3 rounded-lg bg-slate-200/60 dark:bg-black/20 text-gray-500 dark:text-gray-400 border border-transparent">
                ...
                <input 
                    ...
                    className="w-full p-3 rounded-lg bg-white/60 dark:bg-black/20 border border-transparent focus:border-glow-light dark:focus:border-glow-dark focus:ring-2 focus:ring-glow-light/50 dark:focus:ring-glow-dark/50 focus:outline-none transition-all" 
                />
            )}
