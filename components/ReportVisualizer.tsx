...
const ReportVisualizer: React.FC<ReportVisualizerProps> = ({ htmlContent, onClose, isLoading, isOpen, onRegenerate }) => {
  ...
  return (
    ...
    >
      <GlassCard className={`w-full h-full max-w-7xl flex flex-col p-4 sm:p-6 transition-all duration-300 ease-in-out ${isActive ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
