"""xAI Grok LLM provider implementation (OpenAI-compatible API via httpx)."""
...
from .models import GROK_MODELS
...
class GrokProvider(LLMProvider):
    """Provider for xAI Grok models using the OpenAI-compatible REST API."""

    def __init__(self, api_key: str | None = None, **kwargs):
        super().__init__(api_key=api_key or os.environ.get("XAI_API_KEY"), **kwargs)
