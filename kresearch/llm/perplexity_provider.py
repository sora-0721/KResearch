"""Perplexity LLM provider implementation (OpenAI-compatible API via httpx)."""
...
from .models import PERPLEXITY_MODELS
...
class PerplexityProvider(LLMProvider):
    """Provider for Perplexity models using the OpenAI-compatible REST API."""

    def __init__(self, api_key: str | None = None, **kwargs):
        super().__init__(api_key=api_key or os.environ.get("PERPLEXITY_API_KEY"), **kwargs)
